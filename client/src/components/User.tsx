...
import CSS from "csstype";
    ...
    const UserProfile = () => {
        ...
        const getUser = () => {
            axios
                .get(`http://localhost:4941/api/v1/users/${userId}`, {
            ...
            if (file) {
                ...
                r.onload = (c) => {
                    if (c.target?.result) {
                        ...
                        axios.put(`http://localhost:4941/api/v1/users/${userId}/image`, arrayBuffer,
                            {
                                headers: {
        ...
        const editUserInfo = (passedUser: PatchUser) => {
            ...
            // } console.log('out if')
            axios
                .patch(`http://localhost:4941/api/v1/users/${userId}`, editedUser, {
                    headers: { "x-authorization": userAuthToken },
                })
                .then(
                    (response) => {
